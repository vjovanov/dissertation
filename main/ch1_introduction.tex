...
% How worlds infrastructure depends on high-productivity (elaborate what is high-productivity) and high-performance computation.

% Heterogeneous hardware story.

% DSLs restrict the domain and allow compilers.

% Introduce the DSL users.

% Introduce how it is important that DSLs are user-friendly for the DSL user. And easy
% to develop for the DSL author.
...
% In thesis we tackle the problem. is thesis we tackle the problems with deeply embedded DSLs.
...
%%
%% Staging for performance of shallow DSLs
%%
