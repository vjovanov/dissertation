...
Domain-specific language (DSL) compilers often require knowledge of values known only
 at program runtime to perform domain-specific optimizations. For example,
 ...
 the right join order~\cite{selinger1979access}. Consider the example of matrix-chain multiplication:\begin{lstparagraph}
